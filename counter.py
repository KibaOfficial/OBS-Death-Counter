...
class TextContent:
    def __init__(self, source_name=None, text_string="Beispiel text"):
...
def script_properties():
    ...
    S.obs_properties_add_text(
        props, "counter_text1", "[1]Zähler Text", S.OBS_TEXT_DEFAULT
    )
    p = S.obs_properties_add_int(
        props, "counter_1", "Startwert", -999999, 999999, 1
    )
    ...
    S.obs_properties_add_text(
        props, "counter_text2", "[2]Zähler Text", S.OBS_TEXT_DEFAULT
    )
    p = S.obs_properties_add_int(
        props, "counter_2", "Startwert", -999999, 999999, 1
    )
...
<a href="https://twitch.tv/KibaOfficial"> Twitch </a>
<h3 style="color:orange">made by KibaOfficial</h3>
<a href="https://dsc.gg/KibaOfficial"> Discord </a> <br>
""".format(
    **locals()
)
